...
model=word2vec.Word2Vec.load('save.model')
...
posinput=buidwordvec('posout.txt')

neginput=buidwordvec('negout.txt')
...
clf=SVC(C=0.5,kernel='rbf',gamma=20,decision_function_shape='ovo')
...
#
# r2=model.most_similar("美国",topn=8)
# print(r2)
